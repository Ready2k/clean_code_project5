// Prompt Manager interface - Central orchestrator for prompt lifecycle management
...
export interface PromptManager {
   ...
   */
  createPrompt(humanPrompt: HumanPrompt, metadata: { title: string; summary: string; tags: string[]; owner: string }): Promise<PromptRecord>;
   ...
   */
  enhancePrompt(id: string, options?: { preserve_style?: boolean; target_provider?: string }): Promise<EnhancementResult>;
