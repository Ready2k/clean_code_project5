...
export declare class FileRatingSystem implements RatingSystem {
    private ratingsDir;
    private runLogsDir;
     ...
     */
    getTopRatedPrompts(_limit: number): Promise<PromptRecord[]>;
    /**
...
//# sourceMappingURL=file-rating-system.d.ts.map